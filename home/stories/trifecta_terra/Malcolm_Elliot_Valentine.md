...
aliases: |
    Doctor<br>
    Dr. Valentine<br>
    The Royal Architect<br>
    The Father of Monsters
nicknames: |
    Old Man (by C0G-1T0 and M3T-R)<br>
    My Architect (by C0G-1T0)<br>
age: 49
bday: |
    November 7, 2024
gender: <div class="infobox-value" id="quote">"I don't care."</div>
orientation: <div class="infobox-value" id="quote"> "It's... complicated."</div>
pronouns: He / they
faction: Fleshbound
species: Human
occupation: The royal architect (former)<br>
            Mechanic (current)
hobbies: |
    Tinkering with broken tech<br>
    Drinking to forget<br>
    Writing unsent letters<br>
    Arguing with machines<br>
likes: |
    Black coffee<br>
    Sleeping<br>
    Peanuts<br>
    The way C0G-1T0 would say his name<br>
    Re-reading research notes
dislikes: |
    C0G-1T0<br>
    Nostalgia<br>
    Being called 'father'<br>
    Bland food
voice: |
    (VA name)
status: Active
...
image-tabs: |
  <div class="image-tabs">
    <div class="image-tab active">Current</div>
...
Malcolm Elliot Valentine is a human, the previous royal architect of [Terra Vitae](Terra_Vitae.html), and the founder of Valentine Laboratories. He is widely recognized as the primary architect of Project Prometheus and the creator of C0G-1T0 (later C0G-7H3A), the self-declared deity of Machina Nexus.
...
Born in the final years before the accelerated technological acceleration of the 2030s, Valentine grew up in a world transitioning rapidly toward full cybernetic integration. His parents, both systems architects, enrolled him in advanced placement programs where his aptitude for neural network theory first manifested.
